...
void sendToFlask(String jsonData) {
    ...
    String serverURL = "http://172.20.10.5:5000/fingerprint_response";  // Flask endpoint for responses
...
void sendToServer(String jsonData) {
    ...
    String serverURL = "http://172.20.10.5:5000/sync_fingerprints";  // Replace with your Flask server IP
    http.begin(client, serverURL);
    http.addHeader("Content-Type", "application/json");
