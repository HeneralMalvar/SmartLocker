...
void scanI2CDevices() {
    ...
    for (address = 1; address < 127; address++) {
        ...
        if (error == 0) {
            ...
            Serial.printf("⚠ Unknown error at address 0x%X\n", address);
        }
    }
...
void sendToFlask(String jsonData) {
    ...
    String serverURL = "http://192.168.1.100:5000/fingerprint_response";  // Flask endpoint for responses
...
void sendToServer(String jsonData) {
    ...
    String serverURL = "http://192.168.1.100:5000/sync_fingerprints";  // Replace with your Flask server IP
    http.begin(client, serverURL);
    http.addHeader("Content-Type", "application/json");
